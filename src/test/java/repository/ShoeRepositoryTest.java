...
//    기본 메소드 테스트
    ...
    public void findByLowPrice() {
        ...
        shoeSpyList.add(new Shoe("축구화","link","img", new Integer("15000"),new Integer("100000"),"다음", new Integer("3")));
        assertThat(shoeSpyList.get(0).getLprice(), is(new Integer("15000")));
        verify(shoeSpyList).get(0).getLprice();
    }
